...
namespace Fiver.Mvc.Testing.Tests
{
    public class HomeControllerTests
    {
        ...
        [Fact(DisplayName = "Delete_POST_with_valid_Id_returns_RedirectToAction")]
        public void Delete_POST_with_valid_Id_returns_RedirectToAction()
        {
            // Arrange
            var mockService = new Mock<IMovieService>();
            mockService.Setup(service => service.DeleteMovie(It.IsAny<int>()));
